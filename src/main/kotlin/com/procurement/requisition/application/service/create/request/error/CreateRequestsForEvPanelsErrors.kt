package com.procurement.requisition.application.service.create.request.error
...
sealed class CreateRequestsForEvPanelsErrors(
    ...
    class PCRNotFound(cpid: Cpid, ocid: Ocid) :
        CreateRequestsForEvPanelsErrors(
