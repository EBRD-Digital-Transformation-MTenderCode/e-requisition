...
import com.procurement.requisition.application.service.FindCriteriaAndTargetsForPacsService
...
@CommandHandler
class FindCriteriaAndTargetsForPACsHandler(
    override val logger: Logger,
    override val transform: Transform,
    val findCriteriaAndTargetsForPacsService: FindCriteriaAndTargetsForPacsService
) : AbstractHandlerV2() {

    override val action: Action = Actions.FIND_CRITERIA_AND_TARGETS_FOR_PACS

    override fun execute(descriptor: CommandDescriptor): Result<String, Failure> {

        val command = descriptor.getCommand(FindCriteriaAndTargetsForPacsRequest::convert)
