...
import com.procurement.requisition.infrastructure.configuration.properties.CassandraProperties
...
@ComponentScan(basePackages = ["com.procurement.requisition.infrastructure.repository"])
class RepositoryConfiguration constructor(private val cassandraProperties: CassandraProperties) {
